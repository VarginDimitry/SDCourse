...
Храним кэш год, версионирование по хэшу (например, app.\<hash\>.js, font.\<hash\>.css).
...
Данные видео:
* Ключ: "video_fragment:{video_id}:{fragment_idx}:{resolution}".
* Сами данные хранить в бинарных json.
* Храним 5-30 мин, так как в этой информации будут счетчики комментариев, лайков, дизлайков.

Лента комментариев:
* Ключ: "comments:{video_id}:{sort_type}:{page}".
* Сами данные хранить в бинарных json.
* Храним 5-30 мин.
...
* При необходимости используем SAGA.
